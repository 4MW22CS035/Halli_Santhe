...
public final class FragmentSplashBinding implements ViewBinding {
  ...
  private FragmentSplashBinding(@NonNull LinearLayout rootView, @NonNull ImageView logoImage,
  ...
  public static FragmentSplashBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentSplashBinding((LinearLayout) rootView, logoImage, titleText);
    }
